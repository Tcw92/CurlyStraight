...
public class Spinner extends GameObject {
    ...
    public Spinner(Vector2d s, Vector2d v, Vector2d d, int spinnerID) {
    ...
    public Spinner copy() {
        Spinner ship = new Spinner(s, v, d, spinnerID);
    ...
    public Spinner update(Action action) {
    ...
    public double dotTo(Spinner other)
    {
    ...
    public double dotDirections(Spinner other)
    {
    ...
    public double distTo(Spinner other)
    {
        Vector2d diff = Vector2d.subtract(other.s,this.s);
        return diff.mag();
    }
    ...
    @Override
    public void update() {
        update(new Action(0, 10, true));
    }

    public void draw(Graphics2D g) {
        color = spinnerID == 0 ? Color.green : Color.blue;
    ...
    public BattleMissile fireMissile() {
        BattleMissile m = new BattleMissile(this.s, this.d, spinnerID);
        if (onCooldown()) {
            return null;
        } else {
            return m;
